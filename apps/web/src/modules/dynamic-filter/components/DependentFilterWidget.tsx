...
interface DependentFilterWidgetProps {
  id: string
  filterKey: string
...
export function DependentFilterWidget({
  id,
  filterKey,
  options,
  config,
  ...
  return (
    <Select value={selected} onValueChange={handleChange} disabled={visibleOptions.length === 0}>
